...
@EndUserText.label: 'Child note for booking'
...
define view entity Zi_ust_asb_booking as select from /dmo/booking_m
composition[0..*] of ZI_UST_ASb_BSUPPL as _BookingSupplement
